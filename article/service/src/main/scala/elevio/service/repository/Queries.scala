...
import doobie._
import elevio.common.model.{Article, ArticleId, ItemsPerPage, ArticleKeyWord, Page, Title}
import shapeless._
import cats.implicits._

object Queries {
  type DBKeyword = ArticleId :: ArticleKeyWord :: HNil
  def articlesFor(page: Page, itemsPerPage: ItemsPerPage)(keyWords: Option[NonEmptyList[ArticleKeyWord]]): ConnectionIO[List[Article]] =
    ???
  /*    (fr"""
         SELECT
          articles.id

...
object App {
  def apply(
    ...
    val articleClient     = ArticleClient(_client, ArticleClientConfig(Uri.unsafeFromString("/"), "v1", JWT("unsage"), ApiKey("das"))) //TODO: Don't hardcode this
